...
public class FrmConsulta extends javax.swing.JFrame {
    ...
    private void aplicarColoresPersonalizados() {
        ...
        if (TemaManager.oscuro) {
            jPanel1.setBackground(new Color(35, 35, 35)); //FONDO GENERAL
            jPanel2.setBackground(new Color(45, 45, 45)); //PANEL SUPERIOR BLANCO
            jLabel1.setForeground(Color.WHITE);
            jLabel3.setForeground(Color.WHITE); //LABELS
            ...
            jTableDatos.setBackground(new Color(45, 45, 45)); //TABLA  
            ...
            jScrollPane1.getViewport().setBackground(new Color(45, 45, 45)); //SCROLL 
            TxtFieldBuscador.setBackground(new Color(55, 55, 55)); //TEXTFIELDS
            ...
            CmbEstado.setBackground(new Color(55, 55, 55)); //COMBOBOX 
            ...
            JButton[] botones = {BtnAgregar, BtnEditar, BtnEliminar, BtnFiltrar, BtnImprimir, BtnLimpiar, BtnActualizacion, BtnOrdenar, BtnBackup}; //BOTONES
            for (JButton b : botones) {
                b.setBackground(new Color(55, 55, 55));
                b.setForeground(Color.WHITE);
            }
            tglTema.setText("☀"); //TOGGLE
            ...
            jPanel1.setBackground(naranja); //CLARO ORIGINAL
            ...
            jTableDatos.setBackground(Color.WHITE); //TABLA
            ...
            TxtFieldBuscador.setBackground(Color.WHITE);  //TEXTFIELDS
    ...
    void actualizarLabelResultado() {
        ...
        if (total <= 0) {  // Si no hay nada o tabla vacía
    ...
    public void buscarActualizacion() {
        new Thread(() -> {
            try {
                ...
                if (versionServer.equals(versionLocal)) {    // SI YA ESTÁ ACTUALIZADO
                ...
                if (opcion == JOptionPane.YES_OPTION) {
                    ...
                    String rutaInstalador = System.getProperty("user.home") + "\\Downloads\\LibertySystemSetup.exe"; // DESCARGAR INSTALADOR
                    ...
                    ProcessBuilder pb = new ProcessBuilder("cmd", "/c", "start", "", rutaInstalador // EJECUTAR INSTALADOR
                    );
                    pb.start();

                    VersionLocal.guardarVersionLocal(versionServer); // IMPORTANTE: actualizar versión LOCAL ANTES DE CERRAR
                    System.exit(0);
                }
            } catch (Exception e) {
                e.printStackTrace();
    ...
    private void BtnFiltrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnFiltrarActionPerformed
        ...
        LineaDAO dao = new LineaDAO();
        DefaultTableModel modelo = dao.filtrarLineasFlexible(estadoIndex, servicioIndex, municipioIndex, estado, servicio, municipio, cantidad);
    ...
    private void BtnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEliminarActionPerformed
        ...
        if (filas.length == 0) {
            javax.swing.JOptionPane.showMessageDialog(this, "Selecciona al menos una fila para eliminar");
            return;
        }
    ...
    private void BtnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditarActionPerformed
        ...
        if (filas.length == 0) {
            JOptionPane.showMessageDialog(this, "Selecciona al menos una fila para editar");
            return;
        }
    ...
    private void TxtFieldBuscadorKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TxtFieldBuscadorKeyTyped
        if (TxtFieldBuscador.getText().length() >= 50) {  // máximo 50 caracteres
            evt.consume();
        }
    ...
    private void tglTemaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tglTemaActionPerformed
        ...
        ConfigTema.guardarTema(TemaManager.oscuro); //GUARDAR EN ARCHIVO

        for (java.awt.Window w : java.awt.Window.getWindows()) { //refrescar otros abiertos
